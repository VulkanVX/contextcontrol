...
public sealed class ProjectFileRules
{
    ...
    private static readonly string[] DefaultLocExtensions =
    [
        ".axaml",
        ".bat",
        ".c",
    ...
    public static ProjectFileRules Load(string projectRoot)
    {
        ...
        return new ProjectFileRules(
            ...
            data.LocExtensions is null ? DefaultLocExtensions : data.LocExtensions,
            supportedExtensions);
    }
    ...
    public void ResetToDefaults()
    {
        ...
        ReplaceSet(_locExtensions, NormalizeExtensions(DefaultLocExtensions));
        RemoveSupportedExtensionsFromIgnored();
    }
