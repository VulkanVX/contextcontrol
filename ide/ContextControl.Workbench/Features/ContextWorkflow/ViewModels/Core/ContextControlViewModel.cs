...
public sealed partial class ContextControlViewModel : ObservableObject
{
    ...
    private Func<IReadOnlyList<ProjectNodeViewModel>>? _projectTreeProvider;
    ...
    private bool _isLocalThinkingEnabled = true;
    ...
    private string _codexStatus = "Codex CLI status pending";
    ...
    private bool _showOnlyHardwareUsableLocalLlms;
    ...
    private readonly Dictionary<ChatRequestProgressViewModel, LocalChatRequestHandle> _localChatRequests = [];

    private sealed record LocalChatRequestHandle(
    ...
    public ContextControlViewModel(WorkbenchSettings settings, bool refreshProviders = true)
    {
        ...
        _promptDraftSaveTimer.Tick += (_, _) =>
        {
        ...
        VisibleStackBackendDependencies = [];
        ...
        RefreshLocalModelsCommand = new RelayCommand<object>(
            parameter => _ = RefreshLocalModelsAsync(ResolveLocalModelRefreshDepth(parameter)),
            _ => !IsRefreshingLocalModels);
    ...
    public AvaloniaList<LocalLlmModelViewModel> VisibleStackLocalLlmModels { get; }
    ...
    public AvaloniaList<LlmBackendDependencyViewModel> VisibleStackBackendDependencies { get; }
    ...
    public bool HasVisibleStackLocalLlmModels => VisibleStackLocalLlmModels.Count > 0;
    public bool HasVisibleStackBackendDependencies => VisibleStackBackendDependencies.Count > 0;
    ...
    public int StackLocalLlmModelCount => LocalLlmModels.Count(IsModelInUserStack);
    public string MyStackSummary => $"{VisibleStackBackendDependencies.Count:N0} backend(s) - {VisibleStackLocalLlmModels.Count:N0}/{StackLocalLlmModelCount:N0} stack model(s)";
    public string MyStackModelSummary => $"{VisibleStackLocalLlmModels.Count:N0}/{StackLocalLlmModelCount:N0} stack model(s) shown";
