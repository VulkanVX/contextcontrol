    ...
    private static string BuildPhaseContract(ContextCapsulePhase phase)
    {
        return phase switch
        {
            ContextCapsulePhase.FileRequest => """
                ...
                Format:
                ide/ContextControl.Workbench/Shell/MainWindow/MainWindow.axaml
                FUNCTION ide/ContextControl.Workbench/Features/ContextWorkflow/ViewModels/Core/ContextControlViewModel.cs :: SymbolName
                EXPAND: ide/ContextControl.Workbench/Features/
                END
