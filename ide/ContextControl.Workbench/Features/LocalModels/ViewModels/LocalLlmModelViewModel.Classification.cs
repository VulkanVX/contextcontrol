...
public sealed partial class LocalLlmModelViewModel
{
    ...
    private static bool SupportsNativeThinkingById(string id)
    {
        return id.Contains("deepseek-r1", StringComparison.OrdinalIgnoreCase)
            || id.Contains("deepseek-v3.1", StringComparison.OrdinalIgnoreCase)
    ...
    private static bool SupportsThinkingOutputById(string id)
    {
        return SupportsNativeThinkingById(id)
            || id.Contains("rwkv", StringComparison.OrdinalIgnoreCase)
    ...
    private static IReadOnlyList<string> ResolvePurposeTags(LocalLlmCatalogModel model)
    {
        ...
        AddTagIf(
            tags,
            SupportsThinkingOutputById(model.Id)
