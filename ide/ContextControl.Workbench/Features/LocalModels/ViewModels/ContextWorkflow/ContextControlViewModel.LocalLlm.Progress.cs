...
public sealed partial class ContextControlViewModel
{
        ...
        bool isCancellable = false)
    {
        ...
        return (item, new Progress<LocalLlmGenerationProgress>(progress =>
        {
            ...
            item.Status = NormalizeGenerationProgressStatus(progress.Status);
    ...
    private static string NormalizeGenerationProgressStatus(string status)
    {
        ...
        return LooksLikeRawCodexEventStatus(clean)
            ? "Thinking..."
            : clean;
    }
