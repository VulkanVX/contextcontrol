...
public sealed class SkillbookService
{
    ...
    public static IReadOnlyList<PromptFlowStep> BuildPromptFlowSteps()
    {
        return
        [
            new("raw-image-browser", "Raw", "Raw on sends the prompt directly", "Prompt text only", "Selected model / Codex CLI", "none", "No ContextControl harness or Skillbook injection", true),
