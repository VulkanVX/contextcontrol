...
public sealed partial class ContextControlViewModel
{
    ...
    private string _skillbookCodexCapsuleText = "";
    ...
    public string SkillbookCodexCapsuleText
    {
        get => _skillbookCodexCapsuleText;
        private set
        {
            if (SetProperty(ref _skillbookCodexCapsuleText, value ?? ""))
            {
                OnPropertyChanged(nameof(HasSkillbookCodexCapsule));
            }
        }
    }
    ...
    public bool HasSkillbookCodexCapsule => !string.IsNullOrWhiteSpace(SkillbookCodexCapsuleText);
