...
public sealed partial class ChatTranscriptRenderControl : Control
{
    ...
    private readonly Dictionary<object, double> _thinkingScrollOffsets = [];
    private readonly Dictionary<object, double> _diagnosticScrollOffsets = [];
    private readonly Dictionary<object, double> _snippetScrollOffsets = [];
