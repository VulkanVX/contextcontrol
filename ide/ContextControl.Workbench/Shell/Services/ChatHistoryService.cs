...
public sealed class ChatHistoryService
{
    ...
    private static ChatHistorySessionData CleanSession(ChatHistorySessionData session)
    {
        return new ChatHistorySessionData
        {
            ...
            DraftPromptModeKey = NormalizeSessionPromptModeKey(session.DraftPromptModeKey),
            DraftIsAutopilotEnabled = session.DraftIsAutopilotEnabled,
    ...
    private static string NormalizeSessionPromptModeKey(string? value)
    {
...
public sealed class ChatHistorySessionData
{
    ...
    public string DraftPromptModeKey { get; set; } = "";
    public bool? DraftIsAutopilotEnabled { get; set; }
